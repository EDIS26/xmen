...
class ProjectScreenDetails extends Component {
  ...
  deleteBoard(key) {
    ...
    firebase.firestore().collection('Mst_Project').doc(key).delete().then(() => {
      ...
      <ScrollView>
        <Card style={styles.container}>
          <View style={styles.subContainer}>
            <View>
              <Text h2>{this.state.project.ProjectID}</Text>
            </View>
            <View>
              <Text h4>{this.state.project.Project}</Text>
            </View>
          </View>
...
export default ProjectScreenDetails;