...
class DeveloperScreenShow extends Component {
  ...
  updateBoard() {
    ...
    updateRef.set({
      NPK: this.developer.NPK,
      Nama: this.developer.Nama,
      HP: this.developer.HP,
      Email: this.developer.Email,
      Alamat: this.developer.Alamat,
    }).then((docRef) => {
      this.setState({
        key: '',
        NPK: '',
...
export default DeveloperScreenShow;